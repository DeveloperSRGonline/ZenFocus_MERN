...
const Timeline = ({ tasks, date, onUpdateTaskTime, onDropUnscheduled, onEditTask, onDeleteTask }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-[#151621] rounded-xl md:rounded-2xl shadow-xl border border-slate-800/50 overflow-hidden pb-20 md:pb-0">
      ...
      <div className="flex flex-col md:flex-row flex-1 overflow-hidden min-h-0">
        <div className="w-full md:w-48 border-b md:border-b-0 md:border-r border-slate-800 p-2 md:p-3 bg-[#0B0C15] overflow-x-auto md:overflow-y-auto no-scrollbar flex md:flex-col gap-2 shrink-0 max-h-[120px] md:max-h-full items-center md:items-stretch">
          <h4 className="text-[9px] md:text-[10px] font-bold text-slate-500 uppercase tracking-wider md:mb-3 shrink-0 self-center md:self-auto mr-4 md:mr-0 whitespace-nowrap">Unscheduled</h4>
        ...
        <div className="flex-1 overflow-y-auto relative custom-scrollbar no-scrollbar bg-[#0B0C15]">
          {hours.map(hour => {
            ...
            return (
              ...
              >
                <div className="w-12 md:w-16 text-right pr-2 md:pr-3 py-2 text-[10px] md:text-xs font-mono font-medium text-slate-500 border-r border-slate-800 bg-[#12131e] shrink-0">
