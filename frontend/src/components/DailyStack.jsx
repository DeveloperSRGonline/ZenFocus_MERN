...
const DailyStack = ({ logs, addLog }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 md:gap-6 h-full animate-in fade-in zoom-in duration-300 pb-20 md:pb-0 overflow-hidden">
      <div className="w-full md:w-1/3 bg-[#151621] p-4 md:p-6 rounded-2xl border border-slate-800/50 shadow-xl flex flex-col overflow-y-auto shrink-0 max-h-[40%] md:max-h-full">
      ...
      <div className="flex-1 bg-[#151621] p-4 md:p-6 rounded-2xl border border-slate-800/50 shadow-xl flex flex-col relative overflow-hidden min-h-0">
